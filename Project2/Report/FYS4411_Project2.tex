...
\begin{figure}[htbp!]
	\centering\includegraphics[width=0.7\linewidth, height=0.5\linewidth]{sigma.png}
...
\begin{figure}[htbp!]
	\centering\includegraphics[width=0.7\linewidth, height=0.5\linewidth]{Gib_learnrate_test.png}
...
The most accurate sampling method seems to be Gibbs, since the produced local energies are on average more close to the analytical ground state energies in terms of both accuracy and the errors (from blocking). For all three sampling methods we see that the local energies for $N_P=1,D=2$ and $N_P=2,D=1$ are the same for each sampling method respectively. From this it seems that the computation of the energy is the same when the sum of the number of particles and dimensions are the same with that sampling method.
